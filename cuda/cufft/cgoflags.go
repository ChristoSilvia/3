...
//
////amazon linux:
//#cgo LDFLAGS:-L/opt/nvidia/cuda/lib64 -L/opt/nvidia/cuda/lib
//#cgo CFLAGS: -I/opt/cuda/include
//
////WINDOWS:
...
//#cgo windows CFLAGS: -IC:/cuda/v5.0/include -IC:/cuda/v5.5/include -IC:/cuda/v6.0/include -IC:/cuda/v6.5/include -IC:/cuda/v7.0/include -w
import "C"
